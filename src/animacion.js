$(function () {
  ...
  const intercambiar = (a, b) => {
    ...
    if (estado == 1) {
      ...
      mover(
        nodo1,
        posicion2.left - posicion1.left,
        posicion2.top - posicion1.top
      );
      mover(
        nodo2,
        posicion1.left - posicion2.left,
        posicion1.top - posicion2.top
      );
      inter = true;
      reservaA = a;
      reservaB = b;
      timeoutIntercambio = setTimeout(() => {
